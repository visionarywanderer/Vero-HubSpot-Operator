...
export function DisconnectModal({
  ...
  const enabled = confirmText.trim() === portalName.trim();

  return (
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal-card" onClick={(e) => e.stopPropagation()}>
        <h3>Disconnect {portalName}?</h3>
        ...
        <div style={{ marginTop: 10, fontSize: 12 }}>Type <strong>{portalName}</strong> to confirm:</div>
